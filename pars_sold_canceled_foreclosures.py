...
response = session.get('https://salesweb.civilview.com/Sales/SalesSearch?countyId=2', data={'IsOpen': 'false'})
...
with open ('Foreclosure_sold_canceled_list.txt', 'w') as fp:
...
with open ('Foreclosure_sold_canceled_details_all.txt', 'w') as fp:
